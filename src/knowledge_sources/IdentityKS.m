classdef IdentityKS < AuditoryFrontEndDepKS
    ...
    methods
        function obj = IdentityKS(modelName, modelVersion)
            ...
            [obj.scaleFunc, obj.tmpFuncs{1}, ~] = ...
                dynLoadMFun([modelFileName '_scaleFunction.mat']);
            [obj.featureFunc, obj.tmpFuncs{2}, obj.featureParam] = ...
                dynLoadMFun([modelFileName '_featureFunction.mat']);
