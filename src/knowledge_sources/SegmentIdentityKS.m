        ...
        function amlttpExecute( obj, afeBlock )
            ...
            for ii = 1 : numel(mask.data)
                softMaskSignal = struct( ...
                           'FsHz', {1/mask.data(ii).hopSize}, ...
                           'Name', {'SoftMask'}, 'Label', {'SoftMask'}, ...
                           'cfHz', {mask.data(ii).cfHz}, ...
                           'Dimensions', {'nSamples x nFilters'}, ...
                           'Channel', {'mono'}, ...
                           'Data', {mask.data(ii).softMask} );
                obj.featureCreator.setAfeData( afeBlock );
                obj.featureCreator.setBlockAnnotations( struct( 'nStreams', numel( mask.data ) ) );
                obj.featureCreator.setBaIdx( 1 );
                obj.featureCreator.setSoftmask( softMaskSignal );
