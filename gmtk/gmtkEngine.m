        ...
        function infer(obj, featureList, cliqueNo)
            ...
            switch(computer)
                ...
                case 'PCWIN64'
                    ...
                    cmdfn = [obj.cygwinPath, 'bash -c -l "', ...
                        makeUnixPath(obj.gmtkJT), ' -iswp1 -of1 ', ...
                        makeUnixPath(featureList), ' -nf1 ', ...
                        num2str(obj.dimFeatures), ' -fmt1 htk -strFile ', ...
                        makeUnixPath(obj.gmStruct), ' -inputMasterFile ', ...
                        makeUnixPath(obj.inputMaster), ' -inputTrainableParameters ', ...
                        makeUnixPath(obj.learedParams), '.gmp -cCliquePrintRange ', ...
                        num2str(cliqueNo), ' -cliqueOutputFileName ', ...
                        makeUnixPath(obj.outputCliqueFile), ' -cliqueListFileName ', ...
                        makeUnixPath(obj.outputCliqueFile), ' -cliquePrintFormat ascii"'];
