function generateGMTKParameters(gmtkEngine, numLocations, featureRange)
...
%   Detailed explanation goes here
    ...
    generateCommonParams(gmtkEngine.workPath, gmtkEngine.dimFeatures, featureRange, numLocations);

    % Generate master file
    generateMasterParams(gmtkEngine.inputMaster, numLocations);

    % Generate trainable master file
    generateTrainableMasterParams(gmtkEngine.inputMasterTrainable, numUsedFeatures, numLocations);

end

function generateCommonParams(workPath, dimFeatures, featureRange, numLocations)
...
function generateMasterParams(outfn, numLocations)
% Generate non-trainable paramerters
    ...
    print_non_trainable_params(fid, numLocations);
    fclose(fid);
end

function generateTrainableMasterParams(outfn, numUsedFeatures, numLocations)
